...
//         <div className='py-7 pl-8 text-left'>
//           <h1 className='brand text-4xl text-white'>CleanCast</h1>
//         </div>

//         <div className='py-6 px-5'>
//           <Link to="/home" className='text-white text-xl flex gap-3 my-3 items-center'>
//             <CiHome className='text-3xl'/>
//             <h3>Home</h3>
//           </Link>

//           <Link to="/search" className='text-white text-xl gap-3 my-3 flex items-center'>
//             <CiSearch className='text-3xl'/>
//             <h3>Search</h3>
//           </Link>

//           <Link to="/reels" className='text-white text-xl gap-3 my-3 flex items-center'>
//             <CiVideoOn className='text-3xl'/>
//             <h3>Reels</h3>
//           </Link>

//           <Link to="/chats" className='text-white text-xl gap-3 my-3 flex items-center'>
//             <LuMessageCircleDashed className='text-3xl'/>
//             <h3>Chats</h3>
//           </Link>

//           <Link to="/user/profile" className='text-white text-xl gap-3 my-3 flex items-center'>
...
//           <Link 
//             to="/upload" 
//             className='text-white text-xl gap-3 my-3 flex items-center'
//           >
...
//         <div className='flex text-white gap-4 items-center px-3 py-7 mt-auto'>
  ...
  return (
    <>
      ...
      <div className='container hidden md:flex w-[18%] lg:w-[15%] h-screen border-r nav flex-col bg-black/30 backdrop-blur-xl'>
        ...
        <motion.div
          whileHover={{ backgroundColor: "rgba(255,255,255,0.12)" }}
          className='flex text-white gap-4 items-center px-3 py-7 mt-auto w-full rounded-lg'
        >
          <RiMenu5Line className='text-4xl' />
          <h3 className='text-xl'>More</h3>
        </motion.div>
